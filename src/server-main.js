...
// CAI clone: expose SillyTavern's full UI at /admin for power-user / setup tasks.
// The root path serves the Character.AI clone shell (public/index.html).
app.get(['/admin', '/admin/'], (_req, res) => {
    res.sendFile(path.join(serverDirectory, 'public', 'admin.html'));
});
